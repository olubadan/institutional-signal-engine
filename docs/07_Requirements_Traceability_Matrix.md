...
| REQ-AUD-001 — Durable decision and execution lineage | SRS FR-AUD-001/002 | `persistence.py`, `pipeline.py`, `replay.py` | AT-700 | 3, 7 | Verified for run-scoped PostgreSQL counts and field-by-field deterministic replay; run IDs, ingest order, decision order, and mapping provenance persist |
