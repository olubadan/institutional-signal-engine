...
| REQ-ENV-002 — Reproducible Vast toolchain, dependency services, and recovery checks | Mission, SRS | `Makefile`, `infra/vast/`, `docs/environment/VAST_SETUP.md` | AT-201, SESSION-0008/0009 | 2–3 | Blocked: PostgreSQL/Redis containers remain healthy, but credential entry removed six internal runtime variables and dependency restart recovery cannot be reverified until protected restoration is authorized |
...
| REQ-DATA-001 — Resilient Alpaca equity stream | SRS FR-DATA-001/004 | `src/.../providers/alpaca.py` | AT-400, AT-401 | 3–4 | Contract and feed-name regression tests verified; live auth/smoke deferred by protected runtime recovery blocker |
| REQ-DATA-002 — Resilient replaceable options stream | SRS FR-DATA-002/004 | `src/.../providers/thetadata.py`, `infra/vast/*thetadata*` | AT-400, AT-401 | 3–4 | Contract fixtures verified; official Terminal installed with Java 21 and loopback-only ports, but live stream smoke deferred by protected runtime recovery blocker |
