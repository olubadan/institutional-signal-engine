...
| REQ-DATA-001 — Resilient Alpaca equity stream | SRS FR-DATA-001/004 | `src/.../providers/alpaca.py` | AT-400, AT-401 | 3–4 | Verified with contract fixtures; live auth pending credentials |
| REQ-DATA-002 — Resilient replaceable options stream | SRS FR-DATA-002/004 | `src/.../providers/thetadata.py` | AT-400, AT-401 | 3–4 | Verified against current ThetaData v3 contract fixtures; live auth pending credentials |
