...
| REQ-ENV-002 — Reproducible Vast toolchain, dependency services, and recovery checks | Mission, SRS | `Makefile`, `infra/vast/`, `docs/environment/VAST_SETUP.md` | AT-201, SESSION-0008 | 2 | Documented; runtime verification pending |
