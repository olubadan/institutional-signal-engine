...
Run the live command with `--prepared-plan` pointing to the ignition artifact
so the runner fails closed on planner divergence. Do not retry ThetaData REST/OI
endpoints, construct orders, merge PR #5, or begin Phase 5.
