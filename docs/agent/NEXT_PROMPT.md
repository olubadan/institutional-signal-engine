...
```text
Continue Phase 2 for olubadan/institutional-signal-engine as SESSION-0007.

Before taking any action, read AGENTS.md, docs/agent/CURRENT_STATE.md, docs/agent/JOURNAL_INDEX.md, the most recent session record at docs/agent/sessions/20260803T183529Z-SESSION-0006.md, docs/environment/VAST_CANDIDATES.md, and all applicable repository instructions. Compare documented state with live GitHub and report discrepancies before changing the repository.
...
Create and complete SESSION-0007 according to the repository journal rules.
```
